    ...
    <>
      {isloading ? (
        ...
        <div className="flex flex-col h-full gap-5">
          ...
          <div className="bg-white shadow-md rounded-lg p-6  h-[50vh] md:h-[15%] flex flex-col md:flex-row w-full items-center md:justify-between gap-2 ">
            ...
            />
            <Button
              className=" w-[70%] md:w-[15%] cursor-pointer bg-green-600"
